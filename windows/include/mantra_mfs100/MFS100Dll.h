...
int MFS100ExtractISOTemplate(unsigned char* RawImage, unsigned char* Iso_19794_2_Template, int *TemplateLength);
...
int MFS100AutoCapture(MFS100AutoCaptureCallback mfs100AutoCaptureCallback, int Timeout, unsigned char *AutoCaptureRawImage, unsigned char* BitmapImageData, unsigned char* Iso_19794_2_Template, int * ISO_TemplateLength, unsigned char* Ansi_378_2004_Template, int * ANSI_TemplateLength, int *Quality, int *NFIQ, int Detect_Finger);
...
#define MFS100_E_CAPTURING_IN_PROCESS           -1323                //Capturing in Process
#define MFS100_E_IMPROPER_OR_NO_FINGER_PLACEMENT    -1324                  //Improper or No Finger Placement
